...
namespace MyAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        public static List<AudioTrack> _playList = new List<AudioTrack>
        {
            ...
            // A remote URI
            //http://traffic.libsyn.com/wpradio/WPRadio_29.mp3
            //http://dl.dropbox.com/u/5758134/sara.mp3
            //new AudioTrack(new Uri("http://traffic.libsyn.com/wpradio/WPRadio_29.mp3", UriKind.Absolute), 
            //                "Episode 29", 
            //                "Windows Phone Radio", 
            //                "Windows Phone Radio Podcast",
            //                new Uri("Images/Episode29.jpg", UriKind.Relative))
        };

        private RSSub rssSub;
        ...
        public void loadTracks()
        {
            ...
            for (int i = 0; i < rssSub.rssListItems.Count(); i++)
            {
                Debug.WriteLine("Title " + rssSub.rssListItems.ElementAt<RSSItemDetail>(i).Title);
                _playList.Add(new AudioTrack(new Uri(rssSub.rssListItems.ElementAt<RSSItemDetail>(i).URI, UriKind.Absolute),
                             rssSub.rssListItems.ElementAt<RSSItemDetail>(i).Title,
                             null,
                             null,
                             new Uri("Images/Episode29.jpg", UriKind.Relative)));
